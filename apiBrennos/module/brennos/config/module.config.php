...
return [
    ...
    'zf-rest' => [
        ...
        'brennos\\V1\\Rest\\Evento\\Controller' => [
            'listener' => \brennos\V1\Rest\Evento\EventoResource::class,
    ...
    'service_manager' => [
        'factories' => [
            \brennos\V1\Rest\Evento\EventoResource::class => \brennos\V1\Rest\Evento\EventoResourceFactory::class,
        ],
    ],
];
